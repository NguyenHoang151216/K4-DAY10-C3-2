...
<body>
    ...
    <div class="grid-3">
        <div class="card">
            ...
            <div class="metric-label">Retrieval Hit Rate on Clean Baseline Dataset</div>
        ...
        <div class="card">
            ...
            <div class="metric-big" style="color: #fca5a5;">{fmt(c_hit)}</div>
            <div class="metric-label">Impact of Controlled Data Corruption</div>
            <div class="progress-bar-bg">
        ...
        <div class="card">
            ...
            <div class="metric-big" style="color: #6ee7b7;">{fmt(r_hit)}</div>
            <div class="metric-label">Recovery after Replaying Raw Ingestion Snapshot</div>
            <div class="progress-bar-bg">
    ...
    <div class="grid-3">
        <div class="card">
            ...
            <ul style="list-style: none; display: flex; flex-direction: column; gap: 8px; font-size: 13px;">
                <li>✅ <strong>Paper ID Uniqueness:</strong> Passed in Baseline & Repaired</li>
                <li>✅ <strong>Freshness Threshold:</strong> {freshness_report.get('status', 'OK')} ({freshness_report.get('fresh_records', 'N/A')} fresh papers)</li>
                <li>⚠️ <strong>Corrupted Signal:</strong> Expected to trigger at least 2 Quality Failures</li>
            </ul>
        </div>
        <div class="card">
            ...
            <ul style="list-style: none; display: flex; flex-direction: column; gap: 6px; font-size: 12px; color: var(--text-muted);">
                <li>📄 <code>data/clean/papers_clean.csv</code></li>
                <li>📄 <code>data/clean/papers_clean_corrupted.csv</code></li>
                <li>📄 <code>data/clean/papers_clean_repaired.csv</code></li>
                <li>📊 <code>data/results/baseline_metrics.json</code></li>
                <li>📊 <code>data/results/corrupted_metrics.json</code></li>
                <li>📊 <code>data/results/repaired_metrics.json</code></li>
                <li>🛡️ <code>data/reports/corruption_report.md</code></li>
            </ul>
        </div>
        <div class="card">
